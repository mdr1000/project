...
#-------------------------------------------------------------------------------------------------------------------------------------
# Script to install Certification authority server on Linux Ubuntu 24.04
...
#Link to the deb package (vars.example) in the repository

cat <<EOF> /usr/share/easy-rsa/vars.example
...
set_var EASYRSA_REQ_ORG        "MDR1000"
set_var EASYRSA_REQ_EMAIL      "admin@mdr1000.net"
